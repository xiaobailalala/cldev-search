...
public class Host52KolLoadProcess extends AbstractHostLoadProcess {
    ...
    private List<CsvMapping> csvMappings = Arrays.asList(
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_10.csv").setIndices("wb-art-" + dateToStamp("2016-08-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_11.csv").setIndices("wb-art-" + dateToStamp("2016-08-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_12.csv").setIndices("wb-art-" + dateToStamp("2016-08-01")),
            //6000000
            ...
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_33.csv").setIndices("wb-art-" + dateToStamp("2016-09-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_34.csv").setIndices("wb-art-" + dateToStamp("2016-09-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_35.csv").setIndices("wb-art-" + dateToStamp("2016-09-01")),
            //648950
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_36.csv").setIndices("wb-art-" + dateToStamp("2017-01-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_3.csv").setIndices("wb-art-" + dateToStamp("2016-09-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_4.csv").setIndices("wb-art-" + dateToStamp("2016-10-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_5.csv").setIndices("wb-art-" + dateToStamp("2016-10-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_6.csv").setIndices("wb-art-" + dateToStamp("2016-10-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_7.csv").setIndices("wb-art-" + dateToStamp("2016-10-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_8.csv").setIndices("wb-art-" + dateToStamp("2016-10-01")),
            //6000000
            new CsvMapping(dataFolder).setFileName("uid_mid_blog_80w_kol_9.csv").setIndices("wb-art-" + dateToStamp("2016-10-01"))
    );
